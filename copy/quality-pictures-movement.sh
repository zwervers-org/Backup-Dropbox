...
# Function use the Dropbox_Uploader script with the own error checker
  #$1 = Type of use
  #$2 = Source
  #[$3 = Target]
  #[$4 = Special options]
...
#Hier verder met verwerken -> Extract supplier name -> scipt root files -> extract arrival date -> if extractions are corrupt then
